...
class AndroidDynamicIcon {
  static Future<void> initialize({required List<String> classNames}) async {
    await AndroidDynamicIconPlatform.instance.initialize(classNames: classNames);
  }

  Future<void> changeIcon({required List<String> classNames}) async {
    await AndroidDynamicIconPlatform.instance.changeIcon(classNames: classNames);
  }

  Future<String?> getCurrentIcon() async {
    return await AndroidDynamicIconPlatform.instance.getCurrentIcon();
  }
}
